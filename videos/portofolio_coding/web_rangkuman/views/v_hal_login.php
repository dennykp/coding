			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="<?php echo base_url().'index.php/login/auth'?>" method="post">
					...
					<span class="login100-form-title p-b-28">
							<img src='<?php echo base_url(); ?>asset_login/images/user.png' height=50px></img>
						Login to Admin
					</span>
					...
					<div class="wrap-input100 validate-input">
						...
						<span class="label-input100"><center>Username Anda...</span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate="Password is required">
						...
						<span class="focus-input100"></span>
						<span class="label-input100"><center>Password Anda</span>
					</div>
				...
				<div class="login100-more" height="10px" style="background-image: url('<?php echo base_url(); ?>asset_login/images/bg-01.jpg');">
				</div>
			</div>
		</div>
	</div>
