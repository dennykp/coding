                        ...
                        <div class="form-horizontal form-label-left">
                          <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-9 col-xs-12">
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" class="flat"> Darah Lengkap
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                              ...
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" class="flat"> Kimia Klinik - SGOT
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" class="flat"> Kimia Klinik - SGPT
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" class="flat"> Kimia Klinik - Ureum
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" class="flat"> Kimia Klinik - Kreatinin
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" class="flat"> Kimia Klinik - Gula Darah Sesaat
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" class="flat"> Kimia Klinik - HBsAg
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" class="flat"> Kimia Klinik - HIV
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" class="flat"> Tes Kehamilan
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" class="flat"> Feses
                                </label>
                              </div>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-9 col-xs-12">
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" class="flat"> Serologi - TPHA
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" class="flat"> Serologi - VDRL
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" class="flat"> Tes Narkoba - Amphetamine
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" class="flat"> Tes Narkoba - Methamphetamine
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" class="flat"> Tes Narkoba - THC
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" class="flat"> Tes Narkoba - Morphine
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" class="flat"> Tes Narkoba - Benzodizapine 
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" class="flat"> Tes Narkoba - Cocain
                                </label>
                              </div>
                            </div>
